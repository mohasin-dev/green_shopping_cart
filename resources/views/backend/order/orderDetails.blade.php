    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <p style="text-align:right"><button type="button" class="btn btn-sm btn-primary" onclick="printExpense('printExpense')"><i class="fas fa-print"></i> Print</button></p>
                <div class="card" id="printExpense">
                    <div class="header">
...
<script>
    ...
    var printContents = document.getElementById(Expense).innerHTML;
