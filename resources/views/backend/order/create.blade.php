                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group">
                                <input type="checkbox" name="is_discount" id="basic_checkbox_2" class="filled-in">
                                        <label for="basic_checkbox_2">Is Discount?</label>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" name="is_featured" id="basic_checkbox_3" class="filled-in" checked="">
