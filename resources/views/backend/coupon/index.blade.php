...
@section('content')
    <div class="container-fluid">
        <div class="block-header">
            <a class="btn btn-primary waves-effect" href="{{ route('admin.coupon.create') }}">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            ALL COUPON
                            <span class="badge bg-blue">{{ $coupons->count() }}</span>
                        </h2>
                    </div>
                    <div class="body">
                                    ...
                                    @foreach($coupons as $key=>$coupon)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.coupon.edit',$coupon->id) }}" class="btn btn-info waves-effect" disabled>
