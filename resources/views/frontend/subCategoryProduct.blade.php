        ...
        <div class='container'>
            ...
            <div class='col-md-9'>
                    ...
                    <div class="category-product">
                        ...
                        <div class="col-sm-6 col-md-3 wow fadeInUp">
                            ...
                            <div class="product">
                                ...
                                <div class="image"> <a href="detail.html"><img  src="{{ asset('images/product/'. $subcategoryProduct->product_image) }}" alt=""></a> </div>
                                <!-- /.image -->
                                ...
                                <h3 class="name"><a href="detail.html">{{ $subcategoryProduct->product_title }}</a></h3>
                                <div class="rating rateit-small"></div>
                                <div class="description"></div>
                                <div class="product-price"> <span class="price"> {{ price_format($subcategoryProduct->regular_price) }} </span> <span class="price-before-discount">{{ price_format($subcategoryProduct->sale_price) }}</span> </div>
                                <!-- /.product-price -->
                                ...
                                <div class="action">
                                    ...
                                    <li class="add-cart-button btn-group">
                                        <button class="btn btn-primary icon atc" name="{{ $subcategoryProduct->id }}" data-toggle="dropdown" type="button"> <i class="fa fa-shopping-cart"></i> </button>
                                        {{-- <button class="btn btn-primary cart-btn" type="button">Add to cart</button> --}}
                                    </li>
                                    <li class="lnk wishlist"> <a class="add-to-cart atc pointer" name="{{ $subcategoryProduct->id }}" title="Add To Cart">Add to cart </a> </li>
                ...
                <div style="text-align: center;" class="clearfix filters-container">
                    ...
                    {{-- {{ $subcategoryProducts->onEachSide(5)->links() }} --}}
                </div>
                <!-- /.filters-container -->
