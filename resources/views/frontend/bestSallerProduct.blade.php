...
@section('title', 'Best Saller Products')
        ...
        <div class="container">
            <div class="breadcrumb-inner">
                <ul class="list-inline list-unstyled">
                    ...
                    <li class='active'>Best Saller Products</li>
                </ul>
        ...
        <div class='container'>
            ...
            <div class='col-md-9'>
                    ...
                    <div class="category-product">
                        ...
                        <div class="col-sm-6 col-md-3 wow fadeInUp">
                            ...
                            <div class="product">
                                ...
                                <div class="image"> <a href="detail.html"><img  src="{{ asset('images/product/'. $bestSallerProduct->product_image) }}" alt=""></a> </div>
                                <!-- /.image -->
                                ...
                                <h3 class="name"><a href="detail.html">{{ $bestSallerProduct->product_title }}</a></h3>
                                <div class="rating rateit-small"></div>
                                <div class="description"></div>
                                <div class="product-price"> <span class="price"> {{ price_format($bestSallerProduct->sale_price) }} </span> <span class="price-before-discount">{{ price_format(800) }}</span> </div>
                                <!-- /.product-price -->
                                ...
                                <div class="action">
                                    ...
                                    <li class="add-cart-button btn-group">
                                        <button class="btn btn-primary icon atc" name="{{ $bestSallerProduct->id }}" data-toggle="dropdown" type="button"> <i class="fa fa-shopping-cart"></i> </button>
                                        {{-- <button class="btn btn-primary cart-btn" type="button">Add to cart</button> --}}
                                    </li>
                                    <li class="lnk wishlist"> <a class="add-to-cart atc pointer" name="{{ $bestSallerProduct->id }}" title="Add To Cart">Add to cart </a> </li>
                ...
                <div style="text-align: center;" class="clearfix filters-container">
                    {{ $bestSallerProducts->links() }}
                    {{-- {{ $bestSallerProducts->onEachSide(5)->links() }} --}}
                </div>
                <!-- /.filters-container -->
