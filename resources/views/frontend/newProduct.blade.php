        ...
        <div class='container'>
            ...
            <div class='col-md-9'>
                    ...
                    <div class="category-product">
                        ...
                        <div class="col-sm-6 col-md-3 wow fadeInUp">
                            ...
                            <div class="product">
                                ...
                                <div class="image"> <a href="detail.html"><img  src="{{ asset('images/product/'. $newProduct->product_image) }}" alt=""></a> </div>
                                <!-- /.image -->
                                ...
                                <h3 class="name"><a href="detail.html">{{ $newProduct->product_title }}</a></h3>
                                ...
                                <div class="action">
                                    ...
                                    <li class="add-cart-button btn-group">
                                        <button class="btn btn-primary icon atc" name="{{ $newProduct->id }}" data-toggle="dropdown" type="button"> <i class="fa fa-shopping-cart"></i> </button>
                ...
                <div style="text-align: center;" class="clearfix filters-container">
                    {{ $newProducts->links() }}
                    {{-- {{ $newProducts->onEachSide(5)->links() }} --}}
                </div>
                <!-- /.filters-container -->
