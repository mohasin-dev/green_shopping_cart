        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form method="POST" action="{{ route('user.profile.update', Auth::user()->id) }}" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            <div class="row clearfix">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select class="form-control" id="district_id" data-live-search="true" name="district_id">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select class="upazila_id form-control" data-live-search="true" name="upazila_id">
